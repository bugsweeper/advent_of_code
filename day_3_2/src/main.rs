const INPUT: &str = "...............307............130..................969...601...186.........................................312....628..........878..........
......479#../..*..............................#.....*......*............../309.....484........................*......-..........+.....89....
...
fn get_number_left_side(line: &str, till: usize) -> u32 {
    let left = &line[..=till];
    let number_start = if let Some(start) = left.rfind(|symbol: char| !symbol.is_ascii_digit()) {
        start + 1
    } else {
        0
    };
    left[number_start..].parse::<u32>().unwrap_or(0)
}

fn get_number_right_side(line: &str, from: usize) -> u32 {
    let right = &line[from..];
    let number_end = if let Some(end) = right.find(|symbol: char| !symbol.is_ascii_digit()) {
        end
    } else {
        right.len()
    } - 1;
    right[..=number_end].parse::<u32>().unwrap_or(0)
}
...
fn main() {
    ...
    let result: u32 = lines
        ...
        .flat_map(|(line_index, line)| {
            let first_line = if line_index > 0 { line_index - 1 } else { 0 };
            let last_line = if line_index < lines.len() - 1 {
                line_index + 1
            } else {
                line_index
            };
            line.chars()
                .enumerate()
                .filter_map(move |(star_index, symbol)| {
                    if symbol != '*' {
                        return None;
                    }
                    let prev = if star_index > 0 { star_index - 1 } else { 0 };
                    let mut product = 1;
                    let mut count = 0;
                    for line_index in first_line..=last_line {
                        let line = lines_ref[line_index];
                        let mut it = line.chars().skip(prev);
                        match (
                            star_index > 0 && it.next().unwrap().is_ascii_digit(),
                            it.next().unwrap().is_ascii_digit(),
                            star_index < line.len() - 1 && it.next().unwrap().is_ascii_digit(),
                        ) {
                            (true, false, true) => {
                                if count > 0 {
                                    return None;
                                ...
                                count += 2;
                                product *= get_number_left_side(line, star_index - 1);
                                product *= get_number_right_side(line, star_index + 1);
                            }
                            (true, false, false) => {
                                if count > 1 {
                                    return None;
                            ...
                            (true, true, false) => {
                                ...
                                count += 1;
                                product *= get_number_left_side(line, star_index);
                            }
                            (false, false, true) => {
                                if count > 1 {
                                    return None;
                            ...
                            (false, true, true) => {
                                ...
                                count += 1;
                                product *= get_number_right_side(line, star_index);
                            }
                            (true, true, true) => {
                                if count > 1 {
                                    return None;
                                ...
                                count += 1;
                                let number_start = if let Some(start) = line[..=star_index - 1]
                                    .rfind(|symbol: char| !symbol.is_ascii_digit())
                                {
                                    start + 1
                                } else {
                                    0
                                };
                                product *= get_number_right_side(line, number_start);
                            }
                            _ => {}
                        }
                    }
